...
public class VaadinComponentAttributes {
    ...
    public static class ComponentAttributes {
        ...
        private static Map<ComponentAttributes.Side, Map<ComponentAttributes.Size, Attribute<Component>>> paddingAttributeMap =
        ...
        private static Map<ComponentAttributes.Side, Map<ComponentAttributes.Size, Attribute<Component>>> marginAttributeMap =
            Arrays.stream(ComponentAttributes.Side.values()).collect(
                Collectors.toMap(side -> side,
                    side -> Arrays.stream(ComponentAttributes.Size.values()).collect(
                        Collectors.toMap(
